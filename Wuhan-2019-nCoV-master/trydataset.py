# -*- coding: utf-8 -*-
"""
Created on Wed Mar  4 14:37:52 2020
...
toutiao_forum = requests.get("https://raw.githubusercontent.com/BlankerL/DXY-COVID-19-Data/master/csv/DXYArea.csv").json()
...
# 更新数据
csv_file = "Wuhan-2019-nCoV1.csv"
json_file = "Wuhan-2019-nCoV1.json"
xlsx_file = "Wuhan-2019-nCoV1.xlsx"
